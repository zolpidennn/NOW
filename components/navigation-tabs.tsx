            ...
            {companiesLoading ? (
              <div className="flex items-center justify-center py-8">
                <div className="animate-spin">
                  <div className="h-6 w-6 border-2 border-primary border-t-transparent rounded-full"></div>
                </div>
                <p className="ml-2 text-muted-foreground">Carregando empresas...</p>
              </div>
              ...
              companiesList.map((company) => (
                ...
                >
                  <CompanyCard
                    ...
                    city={company.city || ""}
                    state={company.state || ""}
                    logo="https://via.placeholder.com/300x200?text=Empresa"
                    specialties={[]}
                    responseTime="15 min"
                    phone={company.phone || ""}
                  />
              ...
              <div className="flex items-center justify-center py-12 text-muted-foreground">
                <p>Nenhuma empresa disponível no momento</p>
              </div>
            )}
